...
func ResponsesFailed(c *gin.Context, code string, message string) {
...
func ResponsesWssError(c *gin.Context, ws *websocket.Conn, openaiError types.OpenAIError) {
	if ws == nil {
		return
	}
	_ = WssObject(c, ws, map[string]any{
		"type":  "error",
		"error": openaiError,
	})
}
