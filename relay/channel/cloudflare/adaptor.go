...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	case constant.RelayModeResponses:
		if strings.HasPrefix(strings.Split(info.RequestURLPath, "?")[0], "/v1/responses/compact") {
			return fmt.Sprintf("%s/client/v4/accounts/%s/ai/v1/responses/compact", info.ChannelBaseUrl, info.ApiVersion), nil
		}
