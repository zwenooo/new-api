...
func GeminiChatStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	modelForClient := helper.DisplayModelName(c, info)
	...
	helper.StreamScannerHandler(c, resp, info, func(data string) bool {
		...
		if info.SendResponseCount == 0 {
			// send first response
			emptyResponse := helper.GenerateStartEmptyResponse(id, createAt, modelForClient, nil)
		...
		if isStop {
			_ = handleStream(c, info, helper.GenerateStopResponse(id, createAt, modelForClient, finishReason))
		}
		return true
	})
	...
	response := helper.GenerateFinalUsageResponse(id, createAt, modelForClient, *usage)
...
func GeminiChatHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	fullTextResponse.Model = helper.DisplayModelName(c, info)
	usage := dto.Usage{
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	openAIResponse := dto.OpenAIEmbeddingResponse{
		...
		Model:  helper.DisplayModelName(c, info),
	}
