        ...
        {(showSettings || !isMobile) && (
          <Layout.Sider
            className={`
              ...
              ${
                isMobile
                  ? 'fixed left-0 right-0 bottom-0 z-[1000] w-full h-auto shadow-lg'
        ...
        <Layout.Content className='relative min-h-0 flex-1 overflow-hidden'>
          <div className='flex h-full min-h-0 flex-col overflow-hidden lg:flex-row'>
            ...
            {showDebugPanel && !isMobile && (
              <div className='h-full min-h-0 w-96 flex-shrink-0 overflow-hidden'>
                <OptimizedDebugPanel
                  debugData={debugData}
          ...
          {showDebugPanel && isMobile && (
            <div
              className='fixed left-0 right-0 bottom-0 z-[1000] overflow-auto shadow-lg'
              style={{
                top: 'var(--app-header-height)',
                background: 'var(--app-surface-solid)',
              }}
