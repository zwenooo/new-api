...
import SettingsSubscriptionCheckout from '../../pages/Setting/Payment/SettingsSubscriptionCheckout';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Card style={{ marginTop: '10px' }}>
          <SettingsSubscriptionCheckout options={inputs} refresh={onRefresh} />
        </Card>
      </Spin>
    </>
  );
