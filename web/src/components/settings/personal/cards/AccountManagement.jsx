...
const AccountManagement = ({
  ...
  const bindingVisibility =
    status?.personal_setting?.account_binding_visibility || {};
  const isBindingVisible = (key) => {
    if (!isAdminUser) return key === 'email';
    return bindingVisibility?.[key] !== false;
  };
      ...
      <div className='space-y-8'>
        ...
        <div>
          <div className='flex items-center gap-2'>
            ...
            />
            <Typography.Text className='text-base font-semibold text-slate-800 dark:text-slate-200'>
              {t('账户绑定')}
            </Typography.Text>
          </div>
