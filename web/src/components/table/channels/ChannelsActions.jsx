      ...
      <div className='flex flex-col md:flex-row justify-between gap-2'>
        ...
        <div className='flex flex-wrap md:flex-nowrap items-center gap-2 w-full md:w-auto order-2 md:order-1'>
          <Button
            ...
            onClick={() => {
              Modal.confirm({
                title: t('确定要重置所选渠道的已用额度吗？'),
                content: t('该操作会将所选渠道的已用额度清零，不会影响剩余额度。'),
                onOk: () => batchResetChannelUsedQuota(),
              });
            }}
          >
            {t('重置所选渠道已用额度')}
          ...
          <Button
            ...
            disabled={!enableBatchDelete || selectedChannels.length === 0}
            type='tertiary'
            onClick={() => setShowBatchSetGroup(true)}
            className='w-full md:w-auto'
          >
            {t('批量设置分组')}
          </Button>
          ...
          <Button
            ...
            disabled={!enableBatchDelete || selectedChannels.length === 0}
            type='tertiary'
            onClick={() => setShowBatchUpdateModels(true)}
            className='w-full md:w-auto'
          >
            {t('批量设置模型')}
          </Button>
          ...
          <Button
            ...
            disabled={!enableBatchDelete || selectedChannels.length === 0}
            type='tertiary'
            onClick={() => setShowBatchBindUsers(true)}
            className='w-full md:w-auto'
          >
            {t('批量绑定用户')}
          </Button>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item>
                  <Button
                    ...
                    onClick={() => {
                      Modal.confirm({
                        title: t('确定是否要检测全部渠道上游更新？'),
                        content: t('只会检测已启用且开启了上游模型更新检测的渠道'),
                ...
                <Dropdown.Item>
                  <Button
                    ...
                    onClick={() => {
                      Modal.confirm({
                        title: t('确定是否要处理全部渠道上游更新？'),
                        content: t('会批量应用所有待处理的新增和删除模型变更'),
          ...
          <Button
            ...
            onClick={() => {
              Modal.confirm({
                ...
                onOk: () => {
                  Modal.confirm({
                    title: t('请再次确认是否删除所选通道'),
                    content: t('该操作无法撤销，请谨慎操作。'),
                    okText: t('确认删除'),
                    cancelText: t('取消'),
                    okType: 'danger',
