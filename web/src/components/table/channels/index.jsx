...
import BatchModelsModal from './modals/BatchModelsModal';
import BatchBindUsersModal from './modals/BatchBindUsersModal';
import ChannelAbnormalConsumeModal from './modals/ChannelAbnormalConsumeModal';
import ChannelProfitStatsModal from './modals/ChannelProfitStatsModal';
...
const ChannelsPage = () => {
  ...
  return (
    <>
      ...
      <BatchModelsModal {...channelsData} />
      <BatchBindUsersModal {...channelsData} />
      <ChannelAbnormalConsumeModal {...channelsData} />
      <ChannelProfitStatsModal
        visible={channelsData.showChannelProfitStatsModal}
        onCancel={() => channelsData.setShowChannelProfitStatsModal(false)}
        channel={channelsData.currentProfitStatsChannel}
      />
