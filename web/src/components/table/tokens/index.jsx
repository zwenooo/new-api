...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-transfer-api-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-transfer-api-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-transfer-api-container') return true;
      return (
